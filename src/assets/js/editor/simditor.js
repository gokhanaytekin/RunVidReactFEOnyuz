  ...
  Formatter.prototype.autolink = function($el) {
    ...
    for (k = 0, len = linkNodes.length; k < len; k++) {
      ...
      while ((match = re.exec(text)) !== null) {
        ...
        $link = $("<a href=\"" + uri + "\" rel=\"nofollow\"></Link>").text(match[0]);
...
Button = (function(superClass) {
  ...
  Button.prototype._tpl = {
    item: '<li><a tabindex="-1" unselectable="on" class="toolbar-item" href="javascript:;"><span></span></Link></li>',
    menuWrapper: '<div class="toolbar-menu"></div>',
    menuItem: '<li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;"><span></span></Link></li>',
    separator: '<li><span class="separator"></span></li>'
  };
...
ColorButton = (function(superClass) {
  ...
  ColorButton.prototype.renderMenu = function() {
    $('<ul class="color-list">\n  <li><a href="javascript:;" class="font-color font-color-1"></Link></li>\n  <li><a href="javascript:;" class="font-color font-color-2"></Link></li>\n  <li><a href="javascript:;" class="font-color font-color-3"></Link></li>\n  <li><a href="javascript:;" class="font-color font-color-4"></Link></li>\n  <li><a href="javascript:;" class="font-color font-color-5"></Link></li>\n  <li><a href="javascript:;" class="font-color font-color-6"></Link></li>\n  <li><a href="javascript:;" class="font-color font-color-7"></Link></li>\n  <li><a href="javascript:;" class="font-color font-color-default"></Link></li>\n</ul>').appendTo(this.menuWrapper);
